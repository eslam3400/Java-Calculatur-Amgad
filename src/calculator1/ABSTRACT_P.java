 ...
 *
 ِ
 */
public abstract class ABSTRACT_P extends JFrame {
        JButton Button0;
    JButton Button1;
    JButton Button2;
    JButton Button3;
    ...
    public void dark()
{
    ...
    radio5.setBackground(Color.black);
    radio6.setBackground(Color.black);
    radio7.setBackground(Color.black);
    radio8.setBackground(Color.black);
    ...
    radio8.setForeground(Color.red);
